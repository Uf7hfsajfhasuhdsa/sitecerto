...
$config['database']['password'] = "K9RS0ru33";
$config['database']['database'] = "ntofunonline";

/*Name of server*/
$config['server_name'] = "Naruto Fun";
...
$config['vocations'] = array(1=>"Naruto", 2=>"Sasuke", 3=>"Rock Lee", 4=>"Sakura", 5=>"Shikamaru", 7=>"Kakashi", 8=>"Kankuro", 9=>"Gaara", 14=>"Shino", 40=>"Temari", 15=>"Tenten", 18=>"Chouji", 22=>"Hinata", 23=>"Konan", 21=>"Nagato", 31=>"Orochimaru", 25=>"Sai", 27=>"Obito", 28=>"Deidara");


/*List of vocation that exists on server*/
$config['server_vocations'] = array(1=>"Naruto", 2=>"Sasuke", 3=>"Rock Lee", 4=>"Sakura", 5=>"Shikamaru", 7=>"Kakashi", 8=>"Kankuro", 9=>"Gaara", 14=>"Shino", 40=>"Temari", 15=>"Tenten", 18=>"Chouji", 22=>"Hinata", 23=>"Konan", 21=>"Nagato", 31=>"Orochimaru", 25=>"Sai", 27=>"Obito", 28=>"Deidara");
...
$config['newchar_vocations'][0][2] = "Sasuke Sample";
$config['newchar_vocations'][0][3] = "Rock Lee Sample";
$config['newchar_vocations'][0][4] = "Sakura Sample";
$config['newchar_vocations'][0][5] = "Shikamaru Sample";
$config['newchar_vocations'][0][7] = "Kakashi Sample";
$config['newchar_vocations'][0][8] = "Kankuro Sample";
$config['newchar_vocations'][0][9] = "Gaara Sample";
$config['newchar_vocations'][0][14] = "Shino Sample";
$config['newchar_vocations'][0][15] = "Tenten Sample";
$config['newchar_vocations'][0][18] = "Chouji Sample";
$config['newchar_vocations'][0][22] = "Hinata Sample";
$config['newchar_vocations'][0][23] = "Konan Sample";
$config['newchar_vocations'][0][40] = "Temari Sample";
$config['newchar_vocations'][0][21] = "Nagato Sample";
$config['newchar_vocations'][0][31] = "Orochimaru Sample";
$config['newchar_vocations'][0][25] = "Sai Sample";
$config['newchar_vocations'][0][27] = "Obito Sample";
$config['newchar_vocations'][0][28] = "Deidara Sample";
...
/*Title of a website*/
$config['title'] = "NtoRevenge - Powered by [ADM]Leo";
...
$config['pagseguro']['email'] = 'guiknepper15@gmail.com';
// Nome do Produto
...
$config['pagseguro']['token'] = 'ffbee1a5-3695-42df-b2c0-8432a5c1bdcbe1d26925458ab071bd1f754ce6df62270646-f18a-4ba6-9995-3367900011c9';
?>
