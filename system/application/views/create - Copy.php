				...
				<ul style="width:70%">
					...
					<li class="even">
						<select name="vocation" class="keyboardInput" id="vocation">
								...
								<option value="3">Rock Lee</option>
								<option value="4">Sakura</option>
								<option value="5">Shikamaru</option>
								<option value="7">Kakashi</option>
								<option value="8">Kankuro</option>
								<option value="9">Gaara</option>
								<option value="14">Shino</option>
								<option value="15">Tenten</option>
								<option value="18">Chouji</option>
								<option value="22">Hinata</option>
								<option value="23">Konan</option>
								<option value="40">Temari</option>
								<option value="21">Nagato</option>
								<option value="27">Obito</option>
								<option value="25">Sai</option>
								<option value="28">Deidara</option>
								<option value="31">Orochimaru</option>
						</select>
					</li>
					<li class="odd">
