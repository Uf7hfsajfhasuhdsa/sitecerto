<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Hinata</h1></center>
		<center>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/hinata.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Shugohakke Rokujuyon Sho </td>
                    <td> 150 </td>
                    <td> 90 </td>
                    <td> 3500 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Hakke Kuhekisho </td>
                    <td> 400 </td>
                    <td> 140 </td>
                    <td> 6000 </td>
                    <td> sim </td>
                    <td> Drena mana do oponente</td>
                </tr>				
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Byakugan Max</td>
                    <td> 400 </td>
