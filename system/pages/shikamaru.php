<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Shikamaru</h1></center>
		<center>
		...
		<h2 style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"> 380 / 425 </h2>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/shikamaru.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> kage noshuku sa reta max </td>
                    <td> 400 </td>
                    <td> 100 </td>
                    <td> 5000 </td>
                    <td> não </td>
