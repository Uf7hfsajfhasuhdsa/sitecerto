<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Itachi</h1></center>
		<center>
		...
		<h2 style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"> 440 / 415 </h2>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/itachi.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> invocation sword of totsuka </td>
                    <td> 300 </td>
                    <td> 140</td>
                    <td> 6000 </td>
                    <td> sim </td>
                    <td> Cria a Sword of Totsuka </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> tsukuyomi dimension </td>
                    <td> 400 </td>
                    <td> 140 </td>
                    <td> 20000 </td>
                    <td> sim </td>
                    <td> Envia o alvo junto com você para outra dimensão </td>
                </tr>
