<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Kakashi</h1></center>
		<center>
		...
		<h2 style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"> 370 / 370 </h2>
		...
		<h3 style="display:inline;color: #0077ff; font-size: 20px; font-weight: bold">Classe: Especialist</h3>
		</br>
		</center>
    </header>
    <body>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/kakashi.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> suiton suiryudan no jutsu </td>
                    <td> 30 </td>
                    <td> 30 </td>
                    <td> 300 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> magen narakumi no jutsu </td>
                    <td> 100 </td>
                    <td> 90 </td>
                    <td> 4000 </td>
                    <td> sim </td>
                    <td> Cancela Buff de speed no target </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> doton doryu heki </td>
                    <td> 100 </td>
                    <td> 90 </td>
                    <td> 20000 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Magen Kyo Tenchiten </td>
                    <td> 150 </td>
                    <td> 100 </td>
                    <td> 10000 </td>
                    <td> sim </td>
                    <td> Deixa o target bêbado </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> kuchyose pakkun </td>
                    <td> 200 </td>
                    <td> 120 </td>
                    <td> 10000 </td>
                    <td> não </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> genjutsu sharingan </td>
                    <td> 325 </td>
                    <td> 150 </td>
                    <td> 10000 </td>
                    <td> sim </td>
                    <td> Jutsu que silencia o jogador </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> susanooo max </td>
                    <td> 400 </td>
