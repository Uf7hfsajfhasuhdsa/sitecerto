<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Hashirama</h1></center>
		<center>
		...
		<h2 style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"> 430 / 425 </h2>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/hashirama.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Moku Bunshin no Jutsu </td>
                    <td> 300 </td>
                    <td> 130 </td>
                    <td> 10000 </td>
                    <td> não </td>
                    <td> Clone de madeira </td>
                </tr>				
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Mokuton Mokuryu no Jutsu </td>
                    <td> 400 </td>
                    <td> 130 </td>
                    <td> 6000 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Mokuton Mokujin no Jutsu</td>
                    <td> 450 </td>
                    <td> 140 </td>
                    <td> 10000 </td>
                    <td> não </td>
