<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Naruto</h1></center>
		<center>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/naruto.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> tajuu kage bunshin no jutsu max </td>
                    <td> 250 </td>
                    <td> 120 </td>
                    <td> 5000 </td>
                    <td> não </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> chou oodama rasenshuriken </td>
                    <td> 300 </td>
                    <td> 120 </td>
                    <td> 5000 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> chou oodama rasen tarengan  </td>
                    <td> 400 </td>
                    <td> 130 </td>
                    <td> 6000 </td>
                    <td> sim </td>
