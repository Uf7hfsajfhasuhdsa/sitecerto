<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Sai</h1></center>
		<center>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/sai.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Ninpou Choujuu Bakuhatsu </td>
                    <td> 100 </td>
                    <td> 80 </td>
                    <td> 5000 </td>
                    <td> não </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Ninpou Choujuu Giga Lion </td>
                    <td> 250 </td>
                    <td> 110 </td>
                    <td> 4500 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Ninpou Choujuu Giga Sentoki </td>
                    <td> 400 </td>
                    <td> 130 </td>
                    <td> 6000 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Kuchyose Beast </td>
                    <td> 400 </td>
                    <td> 140 </td>
                    <td> 10000 </td>
                    <td> não </td>
                    <td> Invoca um leão </td>
                </tr>				
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Ninpou Choujuu Boei Max</td>
                    <td> 400 </td>
                    <td> 100 </td>
                    <td> 10000 </td>
                    <td> não </td>
