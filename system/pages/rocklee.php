<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Lee</h1></center>
		<center>
		...
		<h2 style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"> 440 / 350 </h2>
		<h1 id="mana" style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"></h1>
		<br>
		<h3 id="classe" style="display:inline;color: #0077ff; font-size: 20px; font-weight: bold"></h3>
		<h3 style="display:inline;color: #0077ff; font-size: 20px; font-weight: bold">Classe: Off Tank</h3>
		</br>
		</center>
    </header>
    <body>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/rock lee.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> taijutsu speed  </td>
                    <td> 25 </td>
                    <td> 10 </td>
                    <td> 0 </td>
                    <td> não </td>
                    <td> Aumenta a velocidade do personagem. </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> taijutsu defense </td>
                    <td> 25 </td>
                    <td> 10 </td>
                    <td> 0 </td>
                    <td> não </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> taijutsu regeneration </td>
                    <td> 25 </td>
                    <td> 10 </td>
                    <td> 0 </td>
                    <td> não </td>
                    <td> Jutsu que cura a vida do personagem. </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> kage buyo </td>
                    <td> 50 </td>
