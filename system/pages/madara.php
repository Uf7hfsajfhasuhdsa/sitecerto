<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Madara</h1></center>
		<center>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/madara.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">  
                    <td> Katon Ryuen Hoka no Jutsu </td>
                    <td> 150 </td>
                    <td> 110 </td>
                    <td> 3500 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Taju Mokuton Bunshin no Jutsu </td>
                    <td> 250 </td>
                    <td> 140 </td>
                    <td> 4000 </td>
                    <td> não </td>
                    <td> Pode invocar até 2 Bunshins</td>
                </tr>				
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Mokuton Mokuryuu no Jutsu </td>
                    <td> 250 </td>
                    <td> 110 </td>
                    <td> 4500 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    ...
                    <td> 10000 </td>
                    <td> sim </td>
                    <td> Silencia o oponente </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Tengai Shinsei Banme </td>
                    <td> 400 </td>
                    <td> 130 </td>
                    <td> 6000 </td>
                    <td> sim </td>
