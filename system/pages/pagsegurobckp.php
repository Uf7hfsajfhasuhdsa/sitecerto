...
<table border="0" cellpadding="4" cellspacing="1" width="100%" id="#estilo"><tbody>
    <tr>
        <th colspan="2">Escolha a quantidade para Doar e seja recompensado em pontos:</th>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2">
            <input type="image" src="https://p.simg.uol.com.br/out/pagseguro/i/botoes/carrinhoproprio/btnFin<br />alizar.jpg" name="submit" alt="Pague com PagSeguro - é rápido, grátis e seguro!" />
        </td>
        </tr>
</tbody></table></form><p </a></p><?php } ?>