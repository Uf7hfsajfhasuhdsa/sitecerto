<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Shino</h1></center>
		<center>
		...
		<h2 style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"> 370 / 390 </h2>
		...
		<h3 style="display:inline;color: #0077ff; font-size: 20px; font-weight: bold">Classe: Suport</h3>
		</br>
		</center>
    </header>
    <body>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/shino.png'
				</div>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    ...
                    <td> 5000 </td>
                    <td> não </td>
                    <td> Pode invocar até 2 kikais</td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Kikaichuu Arare no Jutsu </td>
                    <td> 50 </td>
                    <td> 50 </td>
                    <td> 1000 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Kikaichuu Tsumoji no Jutsu </td>
                    <td> 100 </td>
                    <td> 80 </td>
                    <td> 5000 </td>
                    <td> não </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> kikais invenenation </td>
                    <td> 150 </td>
                    <td> 80 </td>
                    <td> 4000 </td>
                    <td> sim </td>
                    <td> Deixa o oponente com lentidão </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Kikaichuu Yajiri no Jutsu </td>
                    <td> 150 </td>
                    <td> 75 </td>
                    <td> 3500 </td>
                    <td> sim </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Kikaichuu Invocate</td>
                    <td> 250 </td>
                    <td> 120 </td>
                    <td> 4500 </td>
                    <td> não </td>
                    <td> Pode invocar até 2 Kikaichuu</td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Kuchyose Kikai Muchidama </td>
                    <td> 300 </td>
                    <td> 140 </td>
                    <td> 10000 </td>
                    <td> não </td>
                    <td> Pode invocar até 2 Muchidama: Eles drenam mana</td>
                </tr>				
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Insects Max</td>
                    <td> 400 </td>
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Kikai Chuu Debuff </td>
                    <td> 400 </td>
                    <td> 140 </td>
                    <td> 15000 </td>
                    <td> sim </td>
                    <td> Reduz as habilidades do Oponente por 10 segundos</td>
                </tr>
