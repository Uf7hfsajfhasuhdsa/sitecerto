<html>
    ...
    <header>
        <center><h1 style="color: #ffba00; font-size: 40px; font-weight: bold" id="nomePersonagem">Hidan</h1></center>
		<center>
		...
		<h2 style="display:inline;color: #ffba00; font-size: 20px; font-weight: bold"> 440 / 430 </h2>
		...
		<h3 style="display:inline;color: #0077ff; font-size: 20px; font-weight: bold">Classe: Tank</h3>
		</br>
		</center>
    </header>
    <body>
		...
		<div style="display: inline-block; position: relative">
			<div style="padding:0px; margin: 0px; display: inline-block" ng-repeat="outfit in outfits">
				<div style="padding:10px">
					<img style="transform: scale(1)" align="center" src='/templates/naruto/personagens/hidan.png'
				</div>
    ...
    <center>
		...
		<br><br>
            <table style="width:100%"  border="1px solid #666">
				...
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Demoniac Jujutsu </td>
                    <td> 100 </td>
                    <td> 100 </td>
                    <td> 10000 </td>
                    <td> não </td>
                    <td> Jutsu de Self Healing </td>
                </tr>
				<tr ng-repeat="spell in spells | orderBy:'lvl'">
                    <td> Scythe Smash </td>
                    <td> 150 </td>
